...
import { ref, computed, inject, onBeforeUnmount, onMounted, Ref, provide } from 'vue';
...
function generatePacket(displayLines: DisplayLine[] = fillEmptyLinesWithShows(currentConfiguration.value), shiftBeta: boolean = false): qmln.Packet {
    if (
        ...
        return new qmln.Packet(
            ...
            new qmln.FunctionSendToInitialSegment([
                ...
                new qmln.CommandDisplayBuffer(undefined, undefined, 0x09),
    ...
    for (let i = 0; i < displayLines.length; i++) {
        ...
        if (line.align === 'marquee' || line.align === 'marquee-reverse') {
            marqueeTextCommands.push(new qmln.CommandShowTextImmediately(
                ...
                undefined, undefined, line.fcolor, line.bcolor, undefined, i + 1, line.textString
            ));
        } else {
            stillTextCommands.push(new qmln.CommandShowTextString(
                undefined, line.fcolor, line.bcolor, undefined, i + 1,
    ...
    let displayData = [
        ...
        ...stillTextCommands,
        new qmln.CommandDisplayBuffer(undefined, Number(animation.value), Number(animationSpeed.value)),
        ...marqueeTextCommands,
        new qmln.CommandEndOfSegmentData(),
    ]
    ...
    if (shiftBeta) {
        ...
        for (let i = 0; i < displayLines.length; i++) {
            ...
            if (line.align === 'marquee' || line.align === 'marquee-reverse') continue;
                ...
                stillTextCommandsShifted.push(new qmln.CommandShowTextString(
                    undefined, line.fcolor, line.bcolor, undefined, y,
                    truncateAndPad(line.textString, 60, line.align)
                ));
            }
        }
        ...
        displayData = [
            ...
            new qmln.CommandDisplayBuffer(undefined, 0x08, 0x07),
            new qmln.CommandClearBuffer(),
            new qmln.CommandShowCurrentTime(),
            ...stillTextCommandsShifted,
            new qmln.CommandDisplayBuffer(undefined, 0x00, 0x09),
            ...marqueeTextCommands,
            new qmln.CommandEndOfSegmentData(),
        ]
    }
...
async function refresh() {
    ...
    shows.value = [...store.table]
        ...
        .map((show, i) => {
            ...
            return {
                ...
                title: cleanedTitle,
                tags: {
                    age: (show.featureRating === '16' || show.featureRating === '18') ? ['(16+)'] : [],
                ...
                intermissionTime: show.intermissionTime as Date | null,
    ...
    timeoutId = setTimeout(() => {
        ...
        sendData(new qmln.Packet(
            undefined, undefined, new qmln.FunctionSetClock(internetTime.value)
...
<template>
    <Teleport defer to="#timetable-main-tp-target">
        <h1>Timetable</h1>
        ...
        <div style="width: min-content; margin: auto;">
            ...
            <div id="matrix-display" :class="{
                ...
                <div v-for="(line, i) in fillEmptyLinesWithShows(currentConfiguration, internetTime)" class="matrix-row"
    ...
    <Teleport defer to="#timetable-settings-tp-target">
            ...
            <Settings @load-walk-ins="refresh">
                <template #connection>
                    <div class="flex buttons" style="gap: 24px;">
                        <Button class="tertiary" @click="sendData(undefined, true)" :disabled="sending.some(s => s)">
                            <span>Nu verzenden</span>
                        </Button>
                        <Button class="tertiary" @click="sendData(new qmln.Packet(
                            undefined, undefined, new qmln.FunctionSetClock(internetTime)
